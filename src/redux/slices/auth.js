...
const authSlice = createSlice({
  ...
  reducers: {
    ...
    checkLibroStart: (state) => {
      state.isCheckingLibroFetching = true;
    },
    checkLibroSuccess: (state, action) => {
      state.isCheckingLibroFetching = false;
      state.currentLibro = action.payload;
    },
    checkLibroFailure: (state) => {
      state.isCheckingLibroFetching = false;
      state.currentLibro = null;
    },
  },
});
